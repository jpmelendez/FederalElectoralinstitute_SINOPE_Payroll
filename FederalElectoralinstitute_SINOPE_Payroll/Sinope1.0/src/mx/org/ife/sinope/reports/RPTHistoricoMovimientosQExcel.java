...
public class RPTHistoricoMovimientosQExcel 
{
	private DTOHistoricoMovimientos dto;
	private Logger logger = Logger.getLogger(RPTHistoricoMovimientosEExcel.class.getName());
	public RPTHistoricoMovimientosQExcel(DTOHistoricoMovimientos dto) {
		this.dto=dto;
	}
	
	public File generaHTML()throws IOException
	{
		File tempFile = null;
		...
		try {
			...
			pw.println("<html>"+
					   "<head><meta http-equiv='Content-Type' content='application/vnd.ms-excel; charset=ISO-8859-1'>");
			pw.println("<body leftmargin='36.0' rightmargin='36.0' topmargin='36.0' bottommargin='36.0'><div align='Center'> <br /></div>");
...
//			pw.println("<tr><td><img src='"+rutaImagen+"' align='Left' width='150' height='65' /></td>");
			...
			}else//hay estado y distrito
			{
				...
				{
					pw.println("<tr><td colspan='6'><table width='100%'><tr><td align='center' width='26%' colspan='3'>Entidad Federativa:</td>");
					pw.println("<td align='center' width='26%' rowspan='2' colspan='3'>JUNTA LOCAL</td><tr><tr>");
					pw.println("<td align='center' width='26%' colspan='3'>"+this.dto.getIdEstado()+"-"+this.dto.getDescEntidad()+"</td>");
					...
					if (distritoSesion.equals("null")||distritoSesion==null||distritoSesion.equals("")) {
						...
						pw.println("<tr><td colspan='6'><table width='100%'><tr><td align='center' width='26%' colspan='3'>Entidad Federativa:</td>");
						pw.println("<td align='center' width='26%' colspan='3'>Distrito:</td></tr><tr>");
						pw.println("<td align='center' width='26%' colspan='3'>"+this.dto.getIdEstado()+"-"+this.dto.getDescEntidad()+"</td>");
						pw.println("<td align='center' width='26%' colspan='3'>"+this.dto.getIdDistrito()+"-"+this.dto.getDescDistrito()+"</td>");
						pw.println("</tr></table></td></tr></table>");
					}
				}
			}
			...
			pw.println("<tr bgcolor='#f5f5fc'><td align='center'  colspan='6'><b>Reporte Hist&oacute;rico de Movimientos</b></td></tr>");
			...
			pw.println("<tr bgcolor='#f5f5fc'><td align='center' colspan='6'><b>Quincena: "+this.dto.getSelQuincena()+"        Movimientos: "+palabra+"</b></td></tr></table><br>");
			...
			{	
				...
				if (st[15].toString().contains(GenericConstantsSinope.Puestos.DIETAS_CONSEJERO_DISTRITAL)
					...
					{
						contador = 0;
						pw.println("<tr><td colspan='6' align='center'>&nbsp;</td></tr>");
						pw.println("<tr bgcolor='#f5f5fc'><td colspan='6' align='center'><b>Nombre del empleado: "+st[1]+"<br>CURP: "+st[2]+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RFC: "+st[3]+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;N&uacute;m Empleado: "+st[4]+"</b></td></tr>");
...
//						pw.println(suma+"<td align='center'>"+st[7]+"</td>");
					...
					if(!anteriorId.equals(""+st[4]))//comprueba que no sea el mismo empleado que en la corrida pasada
					{
						...
						pw.println("<tr><td colspan='6' align='center'>&nbsp;</td></tr>");
						pw.println("<tr bgcolor='#f5f5fc'><td colspan='6' align='center'><b>Nombre del empleado: "+st[1]+"<br>CURP: "+st[2]+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RFC: "+st[3]+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;N&uacute;m Empleado: "+st[4]+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Núm Contrato: "+ contrato +"</b></td></tr>");
						pw.println("<tr bgcolor='#f5f5fc'><td align='center' width='5%'><b>No.</b></td><td align='center' width='10%'><b>Movimiento</b></td><td align='center' width='20%'><b>Fecha</b></td><td align='center' colspan='2'><b>Puesto</b></td><td align='center' width='15%'><b>Plaza</b></td></tr>");
					}
					rfcC=""+st[11];
					nombreC=""+st[12];
...
//							pw.println(suma+"</td>");
			...
			if(anteriorId.equals(""))//no hay datos pero imprime un reglon
			{
				...
				pw.println("<tr bgcolor='#f5f5fc'><td align='center' width='5%'><b>No.</b></td><td align='center' width='10%'><b>Movimiento</b></td><td align='center' width='20%'><b>Fecha</b></td><td align='center' colspan='2'><b>Puesto</b></td><td align='center' width='15%'><b>Plaza</b></td><(/tr>");
				pw.println("<tr><td align='center'>&nbsp;</td><td align='center'>&nbsp;</td><td align='center'>&nbsp;</td><td align='center'>&nbsp;</td><td align='center'>&nbsp;</td><td align='center'>&nbsp;</td></tr>");
			}

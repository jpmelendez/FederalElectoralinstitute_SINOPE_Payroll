...
public class RPTHistoricoMovimientosEHTML {
	
	private Logger logger = Logger.getLogger(RPTHistoricoMovimientosEHTML.class.getName());
	private DTOHistoricoMovimientos dto;
	public RPTHistoricoMovimientosEHTML(DTOHistoricoMovimientos dto) 
	{
		this.dto=dto;
	}
	...
	public File Reporte()throws IOException
	{
		...
		try {
			...
			pw.println("<tr bgcolor='#f5f5fc'><td align='center'><b>EMPLEADO</b></td></tr>");
			pw.println("<span><br /></span><table width='100.0%' align='Center' cellpadding='0.0' cellspacing='0.0' border='1'>");
			//tabla 2
			...
			while(it.hasNext()) {	
				...
				logger.debug("Clave de puesto " + st[15]);
...
//						pw.println(suma+"<td align='center'>"+st[7]+"</td>");
					...
					logger.debug("Entro en el else, no son empleados Consejeros st[7] " + st[7] + " contador " + contador + " suma " + contrato);
					...
					if(!anteriorId.equals(""+st[4]))//comprueba que no sea el mismo empleado que en la corrida pasada
					{
						...
						pw.println("<tr bgcolor='#f5f5fc'><td colspan='6' align='center'><b>Nombre del empleado: "+st[1]+"<br>CURP: "+st[2]+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RFC: "+st[3]+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Núm Empleado: "+st[4]+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Núm Contrato: "+ obtenerContrato(idEmpleadoContrato, numPlazaContrato) +"</b></td></tr>");
						pw.println("<tr bgcolor='#f5f5fc'><td align='center' width='5%'><b>No.</b></td><td align='center' width='10%'><b>Movimiento</b></td><td align='center' width='20%'><b>Fecha</b></td><td align='center' colspan='2'><b>Puesto</b></td><td align='center' width='15%'><b>Plaza</b></td></tr>");
					}
					rfcC=""+st[11];
					nombreC=""+st[12];
...
//							pw.println(suma+"</td>");
			...
			if(anteriorId.equals("")) {//no hay datos pero imprime un reglon
				...
				pw.println("<tr bgcolor='#f5f5fc'><td align='center' width='5%'><b>No.</b></td><td align='center' width='10%'><b>Movimiento</b></td><td align='center' width='20%'><b>Fecha</b></td><td align='center' colspan='2'><b>Puesto</b></td><td align='center' width='15%'><b>Plaza</b></td></tr>");
				pw.println("<tr><td align='center'>&nbsp;</td><td align='center'>&nbsp;</td><td align='center'>&nbsp;</td><td align='center' colspan='2'>&nbsp;</td><td align='center'>&nbsp;</td></tr>");
			}		

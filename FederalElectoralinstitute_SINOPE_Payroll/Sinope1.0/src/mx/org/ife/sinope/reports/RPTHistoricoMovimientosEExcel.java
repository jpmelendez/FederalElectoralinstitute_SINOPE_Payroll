...
//			pw.println("<tr><td><img src='"+rutaImagen+"' align='Left' width='150' height='65' /></td>");
			...
			pw.println("<tr bgcolor='#f5f5fc'><td align='center' colspan='6'><b>EMPLEADO</b></td></tr>");
			pw.println("<span><br /></span><table width='100.0%' align='Center' cellpadding='0.0' cellspacing='0.0' border='1'>");
			//tabla 2
			
			List list=this.dto.getRenglonesEReporte();
	 		String anteriorId="";
...
//						pw.println(suma+"<td align='center'>"+st[7]+"</td>");
					...
					{
						contador = 0;
						String idEmpleadoContrato=st[4].toString();
						String numPlazaContrato=st[10].toString();
						if (st[6] == null)
							contrato="&nbsp;";
						else
							contrato = st[6].toString();
						pw.println("<tr><td colspan='6' align='center'>&nbsp;</td></tr>");
						pw.println("<tr bgcolor='#f5f5fc'><td colspan='6' align='center'><b>Nombre del empleado: "+st[1]+"<br>CURP: "+st[2]+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RFC: "+st[3]+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;N&uacute;m Empleado: "+st[4]+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Núm Contrato: "+ obtenerContrato(idEmpleadoContrato, numPlazaContrato) +"</b></td></tr>");
						pw.println("<tr bgcolor='#f5f5fc'><td align='center' width='5%'><b>No.</b></td><td align='center' width='10%'><b>Movimiento</b></td><td align='center' width='20%'><b>Fecha</b></td><td align='center' colspan='2'><b>Puesto</b></td><td align='center' width='15%'><b>Plaza</b></td></tr>");
					}
					rfcC=""+st[11];
					nombreC=""+st[12];
